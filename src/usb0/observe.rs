...
#[doc = "Provides observability of the D- Pulldown . signal output from the USB OTG module\n\nValue on reset: 1"]
...
#[doc = "Provides observability of the D+ Pullup . signal output from the USB OTG module\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DPPU_A {
...
impl R {
    #[doc = "Bit 4 - Provides observability of the D- Pulldown . signal output from the USB OTG module"]
    #[inline(always)]
    pub fn dmpd(&self) -> DMPD_R {
        DMPD_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 6 - Provides observability of the D+ Pulldown . signal output from the USB OTG module"]
    #[inline(always)]
    pub fn dppd(&self) -> DPPD_R {
        DPPD_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 7 - Provides observability of the D+ Pullup . signal output from the USB OTG module"]
    #[inline(always)]
