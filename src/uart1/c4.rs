...
pub enum RDMAS_A {
    #[doc = "0: If RIE is set and the RDRF flag is set, the RDRF interrupt request signal is asserted to request interrupt service."]
    _0 = 0,
    #[doc = "1: If RIE is set and the RDRF flag is set, the RDRF DMA request signal is asserted to request a DMA transfer."]
    _1 = 1,
}
...
impl<'a> RDMAS_W<'a> {
    ...
    #[doc = "If RIE is set and the RDRF flag is set, the RDRF interrupt request signal is asserted to request interrupt service."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(RDMAS_A::_0)
    }
    #[doc = "If RIE is set and the RDRF flag is set, the RDRF DMA request signal is asserted to request a DMA transfer."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TDMAS_A {
    #[doc = "0: If TIE is set and the TDRE flag is set, the TDRE interrupt request signal is asserted to request interrupt service."]
    _0 = 0,
    #[doc = "1: If TIE is set and the TDRE flag is set, the TDRE DMA request signal is asserted to request a DMA transfer."]
    _1 = 1,
}
...
impl<'a> TDMAS_W<'a> {
    ...
    #[doc = "If TIE is set and the TDRE flag is set, the TDRE interrupt request signal is asserted to request interrupt service."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(TDMAS_A::_0)
    }
    #[doc = "If TIE is set and the TDRE flag is set, the TDRE DMA request signal is asserted to request a DMA transfer."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
