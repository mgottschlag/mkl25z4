#[doc = "Reader of register FILT2"]
pub type R = crate::R<u8, super::FILT2>;
#[doc = "Writer for register FILT2"]
pub type W = crate::W<u8, super::FILT2>;
#[doc = "Register FILT2 `reset()`'s with value 0"]
impl crate::ResetValue for super::FILT2 {
    type Type = u8;
    #[inline(always)]
...
impl FILTSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FILTSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FILTSEL_A::_0000),
            15 => Val(FILTSEL_A::_1111),
            i => Res(i),
        }
    }
