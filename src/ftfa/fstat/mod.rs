...
#[doc = "Possible values of the field `CCIF`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CCIFR {
...
#[doc = "Values that can be written to the field `CCIF`"]
pub enum CCIFW {
    #[doc = "Flash command in progress"]
    _0,
    #[doc = "Flash command has completed"]
...
impl<'a> _CCIFW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: CCIFW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(CCIFW::_0)
    }
    #[doc = "Flash command has completed"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(CCIFW::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
