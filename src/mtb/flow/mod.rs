...
impl R {
    ...
    #[doc = "Bit 0 - If this bit is 1 and WATERMARK is equal to MTB_POSITION[POINTER], then the MTB_MASTER[EN] bit is automatically set to 0"]
    #[inline]
    ...
    #[doc = "Bit 1 - If this bit is 1 and WATERMARK is equal to MTB_POSITION[POINTER], then the MTB_MASTER[HALTREQ] bit is automatically set to 1"]
    #[inline]
