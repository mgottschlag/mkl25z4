...
impl R {
    #[doc = "Bit 2 - This bit is set to 1 automatically when the POINTER value wraps as determined by the MTB_MASTER\\[MASK\\]
bit in the MASTER Trace Control Register"]
    #[inline(always)]
