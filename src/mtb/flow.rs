...
impl R {
    #[doc = "Bit 0 - If this bit is 1 and WATERMARK is equal to MTB_POSITION\\[POINTER\\], then the MTB_MASTER\\[EN\\]
bit is automatically set to 0"]
    #[inline(always)]
    pub fn autostop(&self) -> AUTOSTOP_R {
        AUTOSTOP_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - If this bit is 1 and WATERMARK is equal to MTB_POSITION\\[POINTER\\], then the MTB_MASTER\\[HALTREQ\\]
