...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RXEDGIER {
    #[doc = "Hardware interrupts from UART _S2[RXEDGIF] disabled (use polling)."]
    _0,
    #[doc = "Hardware interrupt requested when UART _S2[RXEDGIF] flag is 1."]
    _1,
}
impl RXEDGIER {
    #[doc = r" Returns `true` if the bit is clear (0)"]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LBKDIER {
    #[doc = "Hardware interrupts from UART _S2[LBKDIF] disabled (use polling)."]
    _0,
    #[doc = "Hardware interrupt requested when UART _S2[LBKDIF] flag is 1."]
    _1,
}
impl LBKDIER {
    #[doc = r" Returns `true` if the bit is clear (0)"]
